...
class Camera:
    def __init__(self, maze, view_range=25):
        self.maze = maze
    ...
    def apply_fog(self, surface, player_x, player_y):
        ...
        player_screen_x = (player_x - self.offset_x) * self.maze.cell_size
        player_screen_y = (player_y - self.offset_y) * self.maze.cell_size
